...
export default function Title(){
    ...
    return(
    <div className="flex">
        <div className="mb-[48px] items-center" >
            <Tag>
                공개
            </Tag>
            <Tag>
        ...
        <div className="mb-[40px] items-center">
            <span className="text-[32px] font-semibold">코드잇 스터디카페 관리 (주말 오전) 모집합니다. 서울 종로구 용산구 서대문</span>
        </div>
        <div className="border-t border-b border-gray-50 max-w-[770px] max-h-[152px] pt-[32px] pb-[32px] pl-[16px] pr-[359px]">
            <div>
            ...
            <div>
                <img className="pt-[8px] pb-[8px] pr-[8px] pl-[8px] mr-[8px]"src={applicationstatus} />
                <span className="text-[18px] font-semibold mr-[37px]">지원현황</span>
