  ...
  return (
    <>
      ...
      <div className='mt-[50px] space-y-4'>
        <div className='w-1/4 h-5 bg-gray-200 rounded origin-left animate-pulseStretchLeft delay-0 max-md:w-2/3' />
        <div className='w-[80%] h-5 bg-gray-300 rounded origin-left animate-pulseStretchLeft delay-200 max-md:w-5/6' />
